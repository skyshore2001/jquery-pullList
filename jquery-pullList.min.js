...
{var msg=null;if(jo_==null){var pullPromptCls=m_defaults.prefix+"-pullPrompt";jo_=$("<div class='"+pullPromptCls+"'></div>");}
...
jo_.html(msg);jo_.height(height).css("lineHeight",height+"px");if(ac=="D"){var pullHintCls=m_defaults.prefix+"-pullHint";var c=cont_.getElementsByClassName(pullHintCls)[0];if(c)
jo_.appendTo(c);else
jo_.prependTo(cont_);}
